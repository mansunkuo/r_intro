...
Please accomplish following tasks:
...
Here is a function to echo different string respect to x and y.
...
makes a complicated model can be abstracted easily.
For example, to compute the adjusted R square:
...
Visualization is one of most powerful R is. 
Recently 
You can easily use R to quick phototyping a web application.
...
- Choose packages that implemented with C, C++ or Fortran.
